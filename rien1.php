...
// Requête pour compter le nombre d'étudiants par niveau
$sql = "SELECT niveau, COUNT(*) as count FROM etudiants WHERE niveau IN ('B1', 'B2', 'B3') GROUP BY niveau";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        $studentCounts[$row['niveau']] = $row['count'];
    }
}
...
<head>
    ...
    <style>
        ...
        /* Cartes pour afficher le nombre d'étudiants par niveau */
        .card-container {
            display: flex;
            justify-content: space-between;
            gap: 20px;
...
<body>
    ...
    <div class="content">
        ...
        <div class="card-container">
            <div class="card card-b1">
                <div class="card-body">
                    <h5 id="card-title-b1" class="card-title">
                        <i class='bx bxs-user'></i> Étudiants en B1
                    </h5>
                    <p class="card-text"><?php echo $studentCounts['B1']; ?></p>
                </div>
            </div>
            <div class="card card-b2">
                <div class="card-body">
                    <h5 id="card-title-b2" class="card-title">
                        <i class='bx bxs-user'></i> Étudiants en B2
                    </h5>
                    <p class="card-text"><?php echo $studentCounts['B2']; ?></p>
                </div>
            </div>
            <div class="card card-b3">
                <div class="card-body">
                    <h5 id="card-title-b3" class="card-title">
                        <i class='bx bxs-user'></i> Étudiants en B3
                    </h5>
                    <p class="card-text"><?php echo $studentCounts['B3']; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="btn-group" role="group" aria-label="Choix du niveau">
            <a href="listeNoteB1.php" class="btn btn-primary">
                <i class='bx bxs-graduation'></i> B1
            </a>
            <a href="listeNoteB2.php" class="btn btn-success">
                <i class='bx bxs-graduation'></i> B2
            </a>
            <a href="listeNoteB3.php" class="btn btn-info">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            typeWriter("card-title-b1", "Étudiants en B1");
            typeWriter("card-title-b2", "Étudiants en B2");
            typeWriter("card-title-b3", "Étudiants en B3");
        });
