...
foreach ($classes as $classe) {
    ...
    $table_cc =  strtolower($classe) . "_cc";
    ...
    <div class="sidebar">
        ...
        <li>
            ...
            <ul class="dropdown-menu">
                <li><a href="listeNote.php"><img src="uploads/graduated (1).png" alt="">Notes B1</a></li>
                <li><a href="listeNoteb2.php">Notes B2</a></li>
                <li><a href="listeNoteb3.php">Notes B3</a></li>
            </ul>
        </li>
        <!-- <a class="etu" href="listeNote.php"><img src="uploads/graduated (1).png" alt="">Notes</a> -->
