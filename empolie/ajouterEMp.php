...
try {
    ...
    $cours = $emploiDuTemps->obtenirCours($_GET['niveau']);
    ...
    $stmt = $db1->prepare("SELECT nom_matiere FROM matieres WHERE niveau_matiere = :niveau");
    $stmt->bindParam(':niveau', $_GET['niveau'], PDO::PARAM_STR);
    $stmt->execute();
