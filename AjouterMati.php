...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($success) {
            ...
            $query1="ALTER TABLE exam_".$niveau_matiere." ADD COLUMN ".$nom_matiere." VARCHAR(60) DEFAULT 0 ";
            $result1=$db->query($query1);
            $query2="ALTER TABLE note_".$niveau_matiere." ADD COLUMN ".$nom_matiere." VARCHAR(60) DEFAULT 0 ";
            $result1=$db->query($query2);
            $query3="ALTER TABLE tp_".$niveau_matiere." ADD COLUMN ".$nom_matiere." VARCHAR(60) DEFAULT 0 ";
