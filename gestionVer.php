...
<body>
    ...
    <div class="content">
        <div class="header">
            <div class="haut">
                <h2><i class="fas fa-list"></i> Liste des versements</h2>
            </div>
        ...
        <div class="table-container">
            <a href="AjouterVer.php"><button class="ajout"><i class="fas fa-plus"></i> Ajouter un versement</button></a>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                    ...
                    <?php if (!empty($versements)): ?>
                        <?php foreach ($versements as $versement): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <button class="edit" onclick="location.href='edit.php?id=<?= $versement['id']; ?>'"><i class="fas fa-edit"></i></button>
                                    <button class="delete" onclick="openPopup(<?= $versement['id']; ?>)"><i class="fas fa-trash"></i></button>
                                    <button class="details" onclick="location.href='infoVer.php?matricule=<?= $versement['matricule']; ?>'"><i class="fas fa-info-circle"></i></button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
