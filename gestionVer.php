...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="etu" href="gestionVer.php">Versements</a>
    ...
    <div class="content">
        <div class="header">
            <div class="haut">
                ...
                <h2><img src="uploads/alms.gif" alt="">Liste des versements</h2>
            </div>
        ...
        <div class="table-container">
            <a href="AjouterVer.php"><button class="ajout"><img class="rien" src="uploads/add.gif" alt="">Ajouter un versement</button></a>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
