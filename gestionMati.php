...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['delete_id'])) {
    ...
    if ($matiere->supprimerMatiere($id)) {
...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="etu" href="gestionMati.php"><i class='bx bxs-book'></i> Matières</a>
    ...
    <div class="content">
        <div class="header">
            <div class="haut">
                <h2><i class='bx bxs-book'></i> Liste des matières</h2>
            </div>
        ...
        <div class="table-container">
            <a href="AjouterMati.php"><button class="ajout"><i class='bx bx-plus'></i> Ajouter une matière</button></a>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                    ...
                    <?php if (!empty($matieres)): ?>
                        <?php foreach ($matieres as $matiere): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <button class="edit" onclick="location.href='edit.php?id=<?= $matiere['id']; ?>'"><i class='bx bx-edit'></i></button>
                                    <button class="delete" onclick="openPopup(<?= $matiere['id']; ?>)"><i class='bx bx-trash'></i></button>
                                    <button class="details" onclick="location.href='infoMati.php?matricule=<?= $matiere['matricule_prof']; ?>'"><i class='bx bx-info-circle'></i></button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
