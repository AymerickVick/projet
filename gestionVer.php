...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['delete_id'])) {
    ...
    if ($versement->supprimerVersement($id)) {
...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="etu" href="gestionVer.php"><i class='bx bx-money'></i> Versements</a>
    ...
    <div class="content">
        <div class="header">
            <div class="haut">
                <h2><i class='bx bx-money'></i> Liste des versements</h2>
            </div>
        ...
        <div class="table-container">
            <a href="AjouterVer.php"><button class="ajout"><i class='bx bx-plus'></i> Ajouter un versement</button></a>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                    ...
                    <?php if (!empty($versements)): ?>
                        <?php foreach ($versements as $versement): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <button class="edit" onclick="location.href='edit.php?id=<?= $versement['id']; ?>'"><i class='bx bx-edit'></i></button>
                                    <button class="delete" onclick="openPopup(<?= $versement['id']; ?>)"><i class='bx bx-trash'></i></button>
                                    <button class="details" onclick="location.href='infoVer.php?matricule=<?= $versement['matricule']; ?>'"><i class='bx bx-info-circle'></i></button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="6">Aucun versement trouvé.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
