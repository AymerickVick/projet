...
class B2
{
    ...
    {
        $query = "INSERT INTO exam_" . $this->table . " 
    ...
    public function ajouterEtudiantTp()
    {
        $query = "INSERT INTO tp_" . $this->table . " 
                  (matricule,nom, prenom) 
                  VALUES (?, ?, ?)";
    ...
    public function ajouterEtudiantCC()
    {
        $query = "INSERT INTO note_" . $this->table. " 
                  (matricule,nom, prenom) 
                  VALUES (?, ?, ?)";
