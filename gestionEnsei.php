...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="etu" href="gestionEnsei.php">Enseignant</a>
        <a href="statistiques.php">Statistiques</a>
        <a href="gestionMati.php">Matieres</a>
    ...
    <div class="content">
        <div class="header">
            <div class="haut">
                ...
                <h2><img src="uploads/add.gif" alt="">Liste des Enseignants</h2>
            </div>
        ...
        <div class="table-container">
            <a href="AjouterEnsei.php"><button class="ajout"><img class="rien" src="uploads/add.gif" alt="">Ajouter un Enseignants</button></a>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
