                ...
                <table class="table table-bordered text-center">
                    <thead>
                        <tr>
                            ...
                            <th><i class="fas fa-pen"></i> Ajouter une Note TP / 20</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <input type="number" name="notes[<?= $row['matricule']; ?>]"
                                           class="form-control"
                                           step="0.01" min="0" max="20"
                                           value="<?= htmlspecialchars($row[$matiere]); ?>">
                                </td>
                                <?php $result1->data_seek(0); ?>
                                <?php while ($row1 = $result1->fetch_assoc()): ?>
                                    <?php if ($row1['matricule'] == $row['matricule']): ?>
                                        <td>
                                            <input type="number" name="notes_cc[<?= $row1['matricule']; ?>]"
                                                   class="form-control"
                                                   step="0.01" min="0" max="20"
                                ...
                                <?php while ($row2 = $result2->fetch_assoc()): ?>
                                    <?php if ($row2['matricule'] == $row['matricule']): ?>
                                        <td>
                                            <input type="number" name="notes_tp[<?= $row2['matricule']; ?>]"
                                                   class="form-control"
                                                   step="0.01" min="0" max="20"
