...
if (isset($_GET['action']) && $_GET['action'] === 'download_pdf') {
    ...
    $pdf->Cell(0, 10, "Carte d'Étudiant", 0, 1, 'C');
    $pdf->Ln(10);
    ...
    $pdf->SetX(70);
    $pdf->Cell(60, 10, 'Prénom: ' . $etudiant['prenom'], 0, 1);
    $pdf->SetX(70);
    ...
    $pdf->SetX(70);
    $pdf->Cell(60, 10, 'Âge: ' . $etudiant['age'], 0, 1);
...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="etu" href="informationEtudiant.php?matricule=<?= $etudiant['matricule']; ?>"><i class="fas fa-user"></i> Mes Informations</a>
        <a href="MatiereEtu.php?niveau=<?= $etudiant['niveau']; ?>&matricule=<?= $etudiant['matricule']; ?>"><i class="fas fa-book"></i> Mes Matieres</a>
        <a href="NoteEtudiant.php?niveau=<?= $etudiant['niveau']; ?>&matricule=<?= $etudiant['matricule']; ?>"><i class="fas fa-graduation-cap"></i> Mes Notes</a>
        <a href="rien.php?niveau=<?= htmlspecialchars($etudiant['niveau']); ?>&matricule=<?= htmlspecialchars($etudiant['matricule']); ?>"><i class="fas fa-robot"></i> KEYCE AI</a>
        <a href="index.php"><i class="fas fa-sign-out-alt"></i> Déconnexion</a>
    </div>

    <div class="container">
        <h1><i class="fas fa-user-graduate"></i> Détails de l'Étudiant</h1>
        ...
        <a href="?matricule=<?= $matricule; ?>&action=download_pdf" class="pdf-link"><i class="fas fa-download"></i> Télécharger la carte</a>
